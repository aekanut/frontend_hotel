...
<body>
    ...
    <body>
            ...
            <div class="row justify-content-around border border-3 p-2 rounded-2 border-secondary">
                <div class="col-3">
                    <div class="container px-0">
                        <div
                            class="row border rounded-5 rounded-3 border-secondary border-2 bg-white justify-content-around">
                            <div class="col-1">
                                <center>
                            ...
                            <div class="col-10">
                                <input class="form-control form-control-borderless my-1" id="searchText" type="search"
                                    placeholder="ใส่ชื่อจังหวัดหรือที่พัก">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-2">
                    <div class="container px-0">
                        <div class="row border rounded-3 border-secondary border-2 bg-white justify-content-between">
                            ...
                            <div class="col-10">
                                <center>
                                    <input class="form-control form-control-sm form-control-borderless fs-8 my-2"
                                        id="checkIn" min="<?php echo date('Y-m-d'); ?>"
                                        value="<?php echo date('Y-m-d'); ?>" onchange="changeCheckOut(value)"
                                        type="date">
                                </center>
                            </div>
                        </div>
                ...
                <div class="col-2 border rounded-3 border-secondary border-2 bg-white">
                    <div class="container px-0 my-2">
                        <div class="row justify-content-between">
                            ...
                            <div class="col-10">
                                <center>
                                    <select class="form-select form-select-sm form-select-borderless fs-8" id="people"
                ...
                <div class="col-1">
                    <button type="button" class="btn btn-secondary btn-lg my-1 mx-0 scale"
                        onclick="goSearch()">ค้นหา</button>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row my-3">
                <div
                    class="col-4 border-top border-start border-bottom rounded-start border-secondary border-3 bg-white">
                    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="https://www.digopaul.com/wp-content/uploads/related_images/2015/09/09/square_1.jpg"
                                    class="d-block mx-3" style="width: 370px; height: 370px" alt="...">
                            </div>
                ...
                <div class="col-2 border-top border-end border-bottom rounded-end border-secondary border-3 bg-white">
                    s
                </div>
            </div>
